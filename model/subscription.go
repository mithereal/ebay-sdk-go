...
const (
	...
	//
	ImageFormatTexthtml ImageFormat = "texthtml"
)
...
type StatementImage struct {
	XMLName xml.Name `xml:"http://www.ebay.com/marketplace/openebay/v1/services StatementImage"`
...
type BillingStatement struct {
	XMLName xml.Name `xml:"http://www.ebay.com/marketplace/openebay/v1/services BillingStatement"`
...
type Usage struct {
	XMLName xml.Name `xml:"http://www.ebay.com/marketplace/openebay/v1/services Usage"`
...
type Subscriber struct {
	XMLName xml.Name `xml:"http://www.ebay.com/marketplace/openebay/v1/services Subscriber"`
...
type SubscriptionHistory struct {
	XMLName xml.Name `xml:"http://www.ebay.com/marketplace/openebay/v1/services SubscriptionHistory"`
...
type SubscriptionPlan struct {
	XMLName xml.Name `xml:"http://www.ebay.com/marketplace/openebay/v1/services SubscriptionPlan"`
...
type Subscription struct {
	XMLName xml.Name `xml:"http://www.ebay.com/marketplace/openebay/v1/services Subscription"`
...
type SubscriptionPlanVersion struct {
	XMLName xml.Name `xml:"http://www.ebay.com/marketplace/openebay/v1/services SubscriptionPlanVersion"`
...
type SubscriptionPlanVersionDetail struct {
	XMLName xml.Name `xml:"http://www.ebay.com/marketplace/openebay/v1/services SubscriptionPlanVersionDetail"`
...
type RecordAmount struct {
	XMLName xml.Name `xml:"http://www.ebay.com/marketplace/openebay/v1/services RecordAmount"`
...
type RecordTime struct {
	XMLName xml.Name `xml:"http://www.ebay.com/marketplace/openebay/v1/services RecordTime"`
...
type BillingRecord struct {
	XMLName xml.Name `xml:"http://www.ebay.com/marketplace/openebay/v1/services BillingRecord"`
...
type RefundStatusInfo struct {
	XMLName xml.Name `xml:"http://www.ebay.com/marketplace/openebay/v1/services RefundStatusInfo"`
...
type Amount struct {
	XMLName xml.Name `xml:"http://www.ebay.com/marketplace/openebay/v1/services Amount"`
...
type TimeRange struct {
	XMLName xml.Name `xml:"http://www.ebay.com/marketplace/openebay/v1/services TimeRange"`
...
type BaseRequest struct {
	XMLName xml.Name `xml:"http://www.ebay.com/marketplace/openebay/v1/services BaseRequest"`

	Extension []*ExtensionType `xml:"extension,omitempty"`
}

type BaseResponse struct {
	XMLName xml.Name `xml:"http://www.ebay.com/marketplace/openebay/v1/services BaseResponse"`
...
type ExtensionType struct {
	XMLName xml.Name `xml:"http://www.ebay.com/marketplace/openebay/v1/services ExtensionType"`
...
type ErrorMessage struct {
	XMLName xml.Name `xml:"http://www.ebay.com/marketplace/openebay/v1/services ErrorMessage"`
...
type ErrorData struct {
	XMLName xml.Name `xml:"http://www.ebay.com/marketplace/openebay/v1/services ErrorData"`
...
type ErrorParameter struct {
	XMLName xml.Name `xml:"http://www.ebay.com/marketplace/openebay/v1/services ErrorParameter"`
...
type PaginationInput struct {
	XMLName xml.Name `xml:"http://www.ebay.com/marketplace/openebay/v1/services PaginationInput"`
...
type PaginationOutput struct {
	XMLName xml.Name `xml:"http://www.ebay.com/marketplace/openebay/v1/services PaginationOutput"`
...
func NewOpeneBaySubscriptionServicePort(url string, tls bool) *OpeneBaySubscriptionServicePort {
	if url == "" {
		url = ""
	}
...
func (service *OpeneBaySubscriptionServicePort) GetBillingStatements(request *GetBillingStatementsRequest) (*GetBillingStatementsResponse, error) {
	response := &GetBillingStatementsResponse{}
	err := service.client.Call("", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *OpeneBaySubscriptionServicePort) GetBillingRecords(request *GetBillingRecordsRequest) (*GetBillingRecordsResponse, error) {
	response := &GetBillingRecordsResponse{}
	err := service.client.Call("", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *OpeneBaySubscriptionServicePort) SetBillingStartDate(request *SetBillingStartDateRequest) (*SetBillingStartDateResponse, error) {
	response := &SetBillingStartDateResponse{}
	err := service.client.Call("", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *OpeneBaySubscriptionServicePort) SetSubscriptionState(request *SetSubscriptionStateRequest) (*SetSubscriptionStateResponse, error) {
	response := &SetSubscriptionStateResponse{}
	err := service.client.Call("", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *OpeneBaySubscriptionServicePort) GetBillingStatementImage(request *GetBillingStatementImageRequest) (*GetBillingStatementImageResponse, error) {
	response := &GetBillingStatementImageResponse{}
	err := service.client.Call("", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *OpeneBaySubscriptionServicePort) GetRefundStatus(request *GetRefundStatusRequest) (*GetRefundStatusResponse, error) {
	response := &GetRefundStatusResponse{}
	err := service.client.Call("", request, response)
	if err != nil {
		return nil, err
	}
